...
/**
 * Stateless component that is responsible for the entire to-do screen.
 *
...
fun PreviewTodoRow() {
    ...
    TodoRow(todoItem = todo, onItemClicked = {}, modifier = Modifier.fillMaxWidth())
}
